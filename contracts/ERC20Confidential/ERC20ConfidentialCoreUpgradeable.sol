...
abstract contract ERC20ConfidentialCoreUpgradeable is IERC20ConfidentialCore, ReentrancyGuardTransient {
    ...
    /// @param publicDecimals_       Decimals of the host's PUBLIC ERC-20 ledger (e.g. 6 for M0).
    ...
    function claimUnshielded(
        ...
        ERC20ConfidentialLib.claimUnshielded(_getERC20ConfidentialStorage(), id, decryptedAmount, decryptionProof);
    }
